...
<div align="center" style="display: flex; gap: 30px; justify-content: space-between; align-items: center; background-color:#0d1117; padding: 20px; border-radius: 10px; margin-top: 20px;">
  ...
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=hossain-shifat&hide_border=false&background=0D1117&currStreakLabel=61dafb&sideLabels=ffffff&sideNums=ffffff&dates=cccccc&fire=61dafb&ring=61dafb" width="45%" style="min-width: 250px;" />
</div>
